    ...
    def transform(self, texts):
        ...
        if self.tfidf_vectorizer is not None:
            ...
            for text in texts:
                ...
                description_char_length = 0  # Default since we don't have separate description
                description_word_count = 0   # Default since we don't have separate description
                text_length_ratio = transcription_char_length / (description_char_length + 1)
